...
extraTypes:
  0:
    - name: "ArrayOfStringsOrNil"
      desc: ""
      lua_type: "{string} | number | nil"
      source:
        line: 40
        path: "src/testing.lua"
class:
  functions:
    - name: "function"
      desc: ""
...
# aclass <ItemData :member="$frontmatter.class"/>
This is a class
## Types
---
### Command <ItemData :member="$frontmatter.class.types[0]"/>
<TypeAlias :type="$frontmatter.class.types[0]" :typeContext=$frontmatter.typeLinks />An object describing a command

## Functions
---
### function <ItemData :member="$frontmatter.class.functions[0]"/>
